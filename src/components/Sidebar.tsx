import { Home, Calendar, Edit, ListTodo, Lightbulb, Users, ChartBar, BookOpen, Settings2, Briefcase, UserPlus, Inbox, Cog } from "lucide-react";
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { icon: Cog, label: "Automations", path: "/dashboard/automations" },
